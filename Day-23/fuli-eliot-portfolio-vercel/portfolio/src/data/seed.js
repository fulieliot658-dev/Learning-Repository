...
export const seed = {
  ...
  profile: {
    ...
    bio: 'I am a student developer focused on practical web development, responsive design and continuous learning. I work across the front end and the back end, from HTML, CSS, SCSS and React to MySQL and PostgreSQL, and I use Git and GitHub to ship and document everything I build.',
